...
[`markdowns/welcome.md`](https://github.com/CodinGame/techio-basic-template/blob/master/markdowns/welcome.md)  
What you are reading here is generated by this file. Tech.io uses the [Markdown syntax](https://tech.io/doc/reference-markdowns) to render text, media and to inject programming exercises.


[`techio.yml`](https://github.com/CodinGame/techio-basic-template/blob/master/techio.yml)  
